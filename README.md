...
- Unknown or unsupported semantics inside the publication boundary, and malformed/incomplete expression framing in any workflow scalar value, are unproven and block as `error` with exit code `2`.
